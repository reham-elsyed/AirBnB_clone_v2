...
"""This module instantiates an object
    if the environmental variable " hbnb_type_storage" is set to db instantiate database storage engine (DBStorage)
    otherwise indtantiate file storage engine (filestorage)
